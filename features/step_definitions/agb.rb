...
When(/^I go to AGB page\.$/) do
  ...
  my_btn = @browser.find_element(xpath: "//div[@class='footer-block legal-links']/ul/li/a[@href='/tos']")
  ...
  @wait.until { @browser.find_element(xpath: "//h2[@class='title']").displayed? }
end

And(/^I find element title for AGB page\.$/) do
  @browser.find_element(xpath: "//h2[@class='title']")
end
...
And(/^I find element button 14 for AGB page\.$/) do
  ...
  @browser.find_element(xpath: "//div/h4[@id='hinweise']")
end
...
And(/^I find element button 15 for AGB page\.$/) do
 ...
 @browser.find_element(xpath: "//div/h4[@id='ausschluss']")
end
